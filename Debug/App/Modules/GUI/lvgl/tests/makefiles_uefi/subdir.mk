...
C_SRCS += \
../App/Modules/GUI/lvgl/tests/makefiles_uefi/test.c 

OBJS += \
./App/Modules/GUI/lvgl/tests/makefiles_uefi/test.o 

C_DEPS += \
./App/Modules/GUI/lvgl/tests/makefiles_uefi/test.d 


# Each subdirectory must supply rules for building sources it contributes
App/Modules/GUI/lvgl/tests/makefiles_uefi/%.o App/Modules/GUI/lvgl/tests/makefiles_uefi/%.su App/Modules/GUI/lvgl/tests/makefiles_uefi/%.cyclo: ../App/Modules/GUI/lvgl/tests/makefiles_uefi/%.c App/Modules/GUI/lvgl/tests/makefiles_uefi/subdir.mk
...
clean: clean-App-2f-Modules-2f-GUI-2f-lvgl-2f-tests-2f-makefiles_uefi

clean-App-2f-Modules-2f-GUI-2f-lvgl-2f-tests-2f-makefiles_uefi:
	-$(RM) ./App/Modules/GUI/lvgl/tests/makefiles_uefi/test.cyclo ./App/Modules/GUI/lvgl/tests/makefiles_uefi/test.d ./App/Modules/GUI/lvgl/tests/makefiles_uefi/test.o ./App/Modules/GUI/lvgl/tests/makefiles_uefi/test.su

.PHONY: clean-App-2f-Modules-2f-GUI-2f-lvgl-2f-tests-2f-makefiles_uefi
